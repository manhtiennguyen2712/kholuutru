...
<div class="content_right" style="width:100%;">
 ...
 ?>
    <?php
		...
		echo '<input type="submit" name="muahang" value="Xác nhận đặt hàng"/>';
		echo '</form>';
		}
		
		}
	else{
				echo 'Đơn hàng của bạn trống';
	}
	?>
	...
	echo '</div>';
	?>
 <p style="font-size:20px;margin-top:30px;"><a href="index.php">Tiếp tục xem tin</a></p>
</div>