...
<div class="menu">
    	<ul>
            ...
            <li><a href="index.php?xem=huongdan">Hướng dẫn đặt hàng</a></li>
            ...
            <li><a href="index.php?xem=cart">Đơn hàng <img src="image/14085970186309_icon-giao-hang.png" width="20" height="25" /></a></li>			<form action="index.php?xem=ketqua" method="post">
